  ...
  async showUserData(user: Element) {
    ...
    data.then((result) => {
      ...
      <p class="admin__user_info">
        <span class="admin__user_info-admin">Is user admin:</span>
        <span class="is-${result.userConfig.isAdmin ? 'yes' : 'no'}">${result.userConfig.isAdmin ? 'yes' : 'no'}</span>
      </p>
      <p class="admin__user_info">
        <span class="admin__user_info-block">Is user blocked:</span>
        <span class="is-${result.userConfig.isBlock ? 'yes' : 'no'}">${result.userConfig.isBlock ? 'yes' : 'no'}</span>
      </p>
