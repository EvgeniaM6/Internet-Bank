...
- [Back-end](#back-end), +70
- [Функциональность](#функциональность), +550 (550/550)
    ...
    - [Кабинет-пользователя](#кабинет-пользователя), +60
    - [Админка](#админка), +50
...
- Сервер отдаёт корректные ответы, отдаёт HTTP ошибки с нормальными body, по которым можно понять, что произошло, +10.
...
- После ответа на каждый вопрос происходит проверка ответа на сервере, правильный ответ выделяется стилем, отображается дополнительный комментарий по вопросы +10
...
- Роутинг, +20
- Смена языка, +20
- Смена темы дня и ночи, +20
- Адаптивный дизайн, +20
